...
gulp.task('buildWithoutImg',  gulp.series(cleanWithoutImg,
                                gulp.parallel(
                                  html,
                                  styles,
                                  scripts,
...
gulp.task('build',  gulp.series(cleanWithoutImg, cleanImg,
                      gulp.parallel(
                        html,
                        styles,
                        scripts,
...
gulp.task('devMin', gulp.series(cleanWithoutImg,
                      gulp.parallel(
                        html,
                        styles,
                        scripts,
...
gulp.task('dev',  gulp.series(cleanWithoutImg, cleanImg,
                    gulp.parallel(
                      html,
                      styles,
                      scripts,
